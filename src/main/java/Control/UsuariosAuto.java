...
public class UsuariosAuto extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        TableUs.setBackground(new java.awt.Color(0, 0, 102));
        TableUs.setForeground(new java.awt.Color(255, 255, 255));
        ...
        jScrollPane1.setViewportView(TableUs);

        jLabel1.setFont(new java.awt.Font("Serif", 1, 36)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(0, 0, 102));
        jLabel1.setText("USUARIOS AUTORIZADOS");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UsuariosAuto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UsuariosAuto().setVisible(true);
            }
        });
    }
